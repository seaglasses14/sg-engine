...
private:
	...
	static void mouse_key_callback(GLFWwindow* pWindow, int button, int action, int mods);
	...
	void instanced_mouse_key_callback(GLFWwindow* pWindow, int button, int action, int mods);
